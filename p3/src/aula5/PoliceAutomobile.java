...
public class PoliceAutomobile extends Automobile implements Police {
    ...
    public PoliceAutomobile (int year, String plate, String color, int engineSize, int power, int consumption, int fuel, int maxSpeed, int numPassengers, int weight, CarType type, int id) {
